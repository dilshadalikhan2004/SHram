        ...
        <div className="space-y-12 animate-fade-in employer-theme">
            ...
            <div className="glass-card p-20 rounded-[3.5rem] border-white/5 flex flex-col items-center justify-center min-h-[450px] text-center space-y-8 relative overflow-hidden">
                ...
                <div className="space-y-3 relative z-10">
                    <h2 className="text-3xl font-black font-['Space_Grotesk'] uppercase tracking-tight">Deployment Calibration Required</h2>
                    <p className="text-sm text-muted-foreground/60 max-w-lg mx-auto leading-relaxed">
                        The workforce intelligence module is currently synchronizing with regional industrial nodes. Live personnel tracking and performance metrics will be accessible once the uplink is established.
                    </p>
                </div>
                <div className="flex gap-4 relative z-10">
                    ...
                    <div className="px-6 py-2 rounded-full bg-primary/20 border border-primary/30 text-[10px] font-black uppercase tracking-widest text-primary italic">Mode: Encrypted</div>
                </div>
            </div>
        </div>
    );
