        ...
        <div className="space-y-12 animate-fade-in employer-theme">
            <div className="flex justify-between items-end">
                <div className="space-y-4">
                    ...
                    >
                        Payroll <span className="text-primary italic">& Escrow</span>
                    </motion.h1>
            ...
            <div className="glass-card p-20 rounded-[3.5rem] border-white/5 flex flex-col items-center justify-center min-h-[450px] text-center space-y-8 relative overflow-hidden">
                ...
                <div className="space-y-3 relative z-10">
                    <h2 className="text-3xl font-black font-['Space_Grotesk'] uppercase tracking-tight">Ledger Synchronization</h2>
                    <p className="text-sm text-muted-foreground/60 max-w-lg mx-auto leading-relaxed">
                        Secure financial gateways are being initialized. Automated escrow release and transparent payroll tracking will be available following the upcoming security audit and node verification.
                    </p>
                </div>
                <div className="flex gap-4 relative z-10">
                    <div className="px-6 py-2 rounded-full bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-widest text-muted-foreground/40">Network: Mainnet Pending</div>
                    <div className="px-6 py-2 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-[10px] font-black uppercase tracking-widest text-emerald-500 italic">Audit Status: Green</div>
                </div>
            </div>
        </div>
    );
