        ...
        <div className="space-y-12 animate-fade-in employer-theme">
            ...
            <div className="glass-card p-20 rounded-[3.5rem] border-white/5 flex flex-col items-center justify-center min-h-[450px] text-center space-y-8 relative overflow-hidden">
                ...
                <div className="space-y-3 relative z-10">
                    <h2 className="text-3xl font-black font-['Space_Grotesk'] uppercase tracking-tight">Signal Relay Initializing</h2>
                    <p className="text-sm text-muted-foreground/60 max-w-lg mx-auto leading-relaxed">
                        The mission notification system is currently being optimized for high-bandwidth alerts. Critical updates and system-wide broadcasts will be streamed here following the relay calibration.
                    </p>
                </div>
                <div className="flex gap-4 relative z-10">
                    <div className="px-6 py-2 rounded-full bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-widest text-muted-foreground/40">Relay: Active</div>
                    <div className="px-6 py-2 rounded-full bg-amber-500/20 border border-amber-500/30 text-[10px] font-black uppercase tracking-widest text-amber-500 italic">Frequency: Ultra High</div>
                </div>
            </div>
        </div>
    );
