...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-background">
      ...
      <div className="lg:w-1/2 bg-slate-100 dark:bg-slate-950 p-6 lg:p-16 flex flex-col justify-between relative overflow-hidden border-b lg:border-b-0 lg:border-r border-border min-h-[40vh] lg:min-h-screen">
